...
router.get('/doc-appointments/:doctorId', auth('completedRegistration'),validate(appointmentValidation.getDoctor), appointmentController.getDocAppointmnets);
router.get('/my-patients/:doctorId', auth('completedRegistration'),validate(appointmentValidation.getDoctor), appointmentController.getDocPatients);
